...
INSERT INTO key_value (key, value, writing_permission_level) VALUES ('main-president', NULL, 500);
INSERT INTO key_value (key, value, writing_permission_level) VALUES ('vice-president', NULL, 500);
EOF
