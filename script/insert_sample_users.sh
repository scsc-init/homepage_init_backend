...
VALUES
  ('$ID1', '$EMAIL1', 'Alice Kim', '01012345678', '202512345', 'user', 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1),
  ('$ID2', '$EMAIL2', 'Bob Lee', '01023456789', '202512346', 'executive', 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1),
  ('$ID3', '$EMAIL3', 'Carol Choi', '01034567890', '202512347', 'president', 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1);
EOF
