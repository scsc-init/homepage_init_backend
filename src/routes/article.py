...
async def create_article(
    ...
    return await article_service.create_article(body=body, current_user=current_user)
...
async def get_article_by_id(
    ...
    return article_service.get_article_by_id(id=id, current_user=current_user)
...
async def delete_article_by_author(
    ...
    article_service.delete_article_by_author(id=id, current_user=current_user)
...
async def delete_article_by_executive(
    ...
    article_service.delete_article_by_executive(id=id, current_user=current_user)
